...
User.statics.public=function (nickname,id){
    return this.model('Users').find({$and:[{_id:{$ne:id}},{friends:{$nin:[id]}},{requestRecieved:{$nin:[id]}},{nickname:{$regex:nickname}}]},{nickname:1,description:1,_id:0})
}
